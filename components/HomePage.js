...
export function HomePage({ navigation }) {
  ...
  const [values, loading, error] = useCollection(
    collection(database, "users", uid, "restaurants"),
  );
      ...
      <View style={styles.card}>
        <View style={styles.toggleContainer}>
          <TouchableOpacity
            style={[
              styles.toggleButton,
              view === "list" && styles.activeButton,
            ]}
            onPress={() => setView("list")}
          >
            <Text
              style={[styles.toggleText, view === "list" && styles.activeText]}
            >
              Liste
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text
              style={[styles.toggleText, view === "map" && styles.activeText]}
            >
              Kort
            </Text>
          </TouchableOpacity>
